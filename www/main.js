...
var map = {
	"../dashboard/dashboard-tab/dashboard-tab.module": [
		"./src/app/pages/dashboard/dashboard-tab/dashboard-tab.module.ts",
		"default~dashboard-dashboard-tab-dashboard-tab-module~feeds-feeds-tab-feeds-tab-module~pages-users-us~3e956a17",
		"default~dashboard-dashboard-tab-dashboard-tab-module~pages-users-users-module",
		"common",
		"dashboard-dashboard-tab-dashboard-tab-module"
	],
	"../feeds/feeds-tab/feeds-tab.module": [
		"./src/app/pages/feeds/feeds-tab/feeds-tab.module.ts",
		"default~dashboard-dashboard-tab-dashboard-tab-module~feeds-feeds-tab-feeds-tab-module~pages-users-us~3e956a17",
		"common",
		"feeds-feeds-tab-feeds-tab-module"
	],
	"../prep/prep-tab/prep-tab.module": [
		"./src/app/pages/prep/prep-tab/prep-tab.module.ts",
		"prep-prep-tab-prep-tab-module"
	],
	"../store/store-tab/store-tab.module": [
		"./src/app/pages/store/store-tab/store-tab.module.ts",
		"store-store-tab-store-tab-module"
	],
	"../test/test-tab/test-tab.module": [
	...
	"./pages/feeds/feeds-tab/feeds-tab.module": [
		"./src/app/pages/feeds/feeds-tab/feeds-tab.module.ts",
		"default~dashboard-dashboard-tab-dashboard-tab-module~feeds-feeds-tab-feeds-tab-module~pages-users-us~3e956a17",
		"common",
		"feeds-feeds-tab-feeds-tab-module"
...
module.exports = __webpack_require__(/*! D:\sachin\veyev-dev\veyev-dev\src\main.ts */"./src/main.ts");
